...
public abstract class GameObject {
    ...
    private MaterialRenderData createMaterialRenderData(
        ...
        if (ctx != null && ctx.activeShadowMatrix != null) {
            data.shadowMatrix = ctx.activeShadowMatrix;
        } else {
            data.shadowMatrix = data.lightSpaceMatrix;
        }
        ...
        if (ctx != null && ctx.camera != null) {
            ...
            data.projectionMatrix = ctx.camera.getProjectionMatrix();
            data.cameraFar = ctx.camera.getFar();
            data.screenWidth = ctx.screenWidth;
            data.screenHeight = ctx.screenHeight;
        }
